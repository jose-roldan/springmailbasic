package ar.com.egomusic.springmailbasic01.service.impl;

import ar.com.egomusic.springmailbasic01.model.MailModelDTO;
import ar.com.egomusic.springmailbasic01.service.SendingEmailService;
...
public class SendingEmailServiceImpl implements SendingEmailService {
    ...
    public void sendEmail(MailModelDTO mailModelDTO) throws MessagingException, IOException, TemplateException {
        ...
        mimeMessageHelper.addInline("cid", new ClassPathResource("classpath:/test.png"));
